        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              Create a detailed and engaging prompt for your mock interview. This helps set the stage and provides a clear direction for the interview process.
            </p>
          </a>
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              Customize your form with specific questions and criteria that align with your interview goals. Make adjustments as needed to ensure clarity and relevance.
            </p>
          </a>
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              Share your form with candidates and start receiving responses. Monitor their progress and gather valuable feedback to enhance the interview experience.
            </p>
          </a>
        </div>
